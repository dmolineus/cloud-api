...
(
	...
	(
		...
		'permission_rules' => array('isAdmin:act=[delete,edit,editAll,select]:key=[install,reset]', 'forbidden:key=mount'),
	),
	...
	(
		...
		(
			...
			'label_rules' 				=> array('parseDate:index=1', 'addLink:index=0'),			
		),
