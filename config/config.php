 ...
 *   0 disabled
 *   1 only cache meta data
 *   2 cache also files
 * 
 * Usually CloudApis should try linking directly to cloud files, but 
 * if it's not possible they have to be cached instead before the user
 * can download them. Thumbnails are cached as well using dropbox
 */
